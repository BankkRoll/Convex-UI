...
<div className="grid grid-cols-3 gap-4 mt-8 sm:gap-6">
  ...
  >
    ...
    <span className="font-medium mt-2">React</span>
  </LinkedCard>
</div>

<Callout type="info" className="mt-6">
  **Already using shadcn/ui?** Skip to Step 2. This library works with your
  existing setup. The **React** option works with Vite, React Router, Astro,
  Laravel, and other React frameworks.
</Callout>
...
<Callout type="warning" className="mt-6">
  **Framework-specific components.** Make sure to use the right variant for your
  ...
  `password-based-auth-react` for React/Vite).
</Callout>
