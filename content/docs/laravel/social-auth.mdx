...
description: Social authentication block for Laravel Applications
---
...
<BlockPreview name="social-auth-laravel/auth/login" />
...
<BlockItem
  name="social-auth-laravel"
  description="All needed components for the social auth flow"
/>

## Folder structure

This block includes the [Convex client](/ui/docs/laravel/client). If you already have one installed, you can skip overwriting it.

<RegistryBlock itemName="social-auth-laravel" />

## Usage

Once you install the block in your Laravel project, you'll get all the necessary pages and components to set up a social authentication flow. Laravel typically uses Inertia.js or Livewire for React integration.
