...
<BlockItem
  name="dropzone-laravel"
  description="Displays a control for easier uploading of files directly to Convex Storage"
/>

## Folder structure

<RegistryBlock itemName="dropzone-laravel" />

## Introduction

Uploading files should be easy—this component handles the tricky parts for you.

The File Upload component makes it easy to add file uploads to your Laravel app, with built-in support for drag-and-drop, file type restrictions, image previews, and configurable limits on file size and number of files. All the essentials, ready to go.
