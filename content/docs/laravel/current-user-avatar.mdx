...
<BlockItem
  name="current-user-avatar-laravel"
  description="Renders the avatar of the current user."
/>

## Folder structure

<RegistryBlock itemName="current-user-avatar-laravel" />
...
The `CurrentUserAvatar` component is designed to be used anywhere in your Laravel app. Add the `<CurrentUserAvatar />` component to your page and it will render the avatar of the current user, with a fallback.
