---
title: Convex Client
description: Convex client for Vite
---

## Installation

<BlockItem name="convex-client-vite" description="Convex Client for Vite" />

## Folder structure

<RegistryBlock itemName="convex-client-vite" />

## Usage

This block installs a Convex client for connecting your Vite project to Convex. It's designed for use in client-side components with real-time data synchronization.
...
- [Convex Vite Quickstart](https://docs.convex.dev/quickstart/vite)
