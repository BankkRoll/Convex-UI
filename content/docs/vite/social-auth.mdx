...
description: Social authentication block for Vite
---
...
<RegistryBlock itemName="social-auth-vite" />

## Usage

Once you install the block in your Vite project, you'll get all the necessary pages and components to set up a social authentication flow.
