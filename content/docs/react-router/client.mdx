---
title: Convex Client
description: Convex client for React Router
---

## Installation

<BlockItem
  name="convex-client-react-router"
  description="Convex Client for React Router"
/>

## Folder structure

<RegistryBlock itemName="convex-client-react-router" />

## Usage

This block installs a Convex client for connecting your React Router project to Convex. It's designed for use in client-side components with real-time data synchronization.
